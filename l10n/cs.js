OC.L10N.register(
    ...
    "Explanation of the different concepts that constitute access options :<br> - Public: Anyone who has the link can join.<br> - Internal: Only Nextcloud users can join.<br> - Password: Only guests who have the password can join.<br> - Waiting room: A moderator must accept each guest before they can join.<br> - Restricted : Only selected users and groups can access this room." : "Vysvětlení různých pojmů, tvořících možnosti přístupu:<br> - Veřejné: Může se připojit kdokoli, kdo má odkaz.<br> - Interní: Mohou se připojit pouze uživatelé Nextcloudu.<br> - Heslo: Mohou se připojit pouze hosté, kteří znají heslo.<br> - Čekárna: Je třeba, aby moderátor přijal každého hosta zvlášť a až poté se bude host moci připojit.<br> - Omezené: Připojit se mohou pouze vybraní uživatelé a skupiny.",
