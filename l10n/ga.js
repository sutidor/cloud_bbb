OC.L10N.register(
    ...
    "Explanation of the different concepts that constitute access options :<br> - Public: Anyone who has the link can join.<br> - Internal: Only Nextcloud users can join.<br> - Password: Only guests who have the password can join.<br> - Waiting room: A moderator must accept each guest before they can join.<br> - Restricted : Only selected users and groups can access this room." : "Míniú ar na coincheapa éagsúla a chuimsíonn roghanna rochtana: <br> - Poiblí: Is féidir le duine ar bith a bhfuil an nasc aige/aici páirt a ghlacadh. <br> - Inmheánach: Ní féidir ach le húsáideoirí Nextcloud páirt a ghlacadh. <br> - Pasfhocal: Ní féidir ach le haíonna a bhfuil an pasfhocal acu páirt a ghlacadh. <br> - Seomra feithimh: Ní mór do mhodhnóir glacadh le gach aoi sula bhféadann siad páirt a ghlacadh. <br> - Srianta: Ní féidir ach le húsáideoirí agus grúpaí roghnaithe rochtain a fháil ar an seomra seo.",
