OC.L10N.register(
    ...
    "An error occurred while sending the file to the room." : "Pri odosielaní súboru do miestnosti došlo k chybe.",
    "Loading…" : "Nahrávam...",
    ...
    "Only rooms for which you are one of the administrators will be displayed." : "Zobrazené budú iba miestnosti, pre ktoré ste jedným z administrátorov.",
    "Send to" : "Odoslať do",
    "Start with" : "Začat s",
    ...
    "Explanation of the different concepts that constitute access options :<br> - Public: Anyone who has the link can join.<br> - Internal: Only Nextcloud users can join.<br> - Password: Only guests who have the password can join.<br> - Waiting room: A moderator must accept each guest before they can join.<br> - Restricted : Only selected users and groups can access this room." : "Vysvetlenie rôznych konceptov, ktoré tvoria možnosti prístupu :<br> - Verejné: Ktokoľvek, kto má odkaz, sa môže pripojiť.<br> - Interné: Pripojiť sa môžu iba používatelia Nextcloud.<br> - Heslo: Pripojiť sa môžu iba hostia, ktorí majú heslo.<br> - Čakáreň: Moderátor musí každého hosťa schváliť pred pripojením.<br> - Obmedzené : Prístup do tejto miestnosti majú iba vybraní používatelia a skupiny.",
    ...
    "Example configuration for Apache and Nginx" : "Príklad konfigurácie pre Apache a Nginx",
