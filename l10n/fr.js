OC.L10N.register(
    ...
    "Internal" : "Interne",
    "Internal restricted" : "Interne restreint",
    ...
    "Perform media check before usage" : "Effectuer un contrôle des périphériques avant utilisation",
    ...
    "You will be forwarded to the room in the next few seconds." : "Vous serez redirigé vers la salle dans quelques secondes.",
    "Let's go!" : "Allons-y !",
    ...
    "Explanation of the different concepts that constitute access options :<br> - Public: Anyone who has the link can join.<br> - Internal: Only Nextcloud users can join.<br> - Password: Only guests who have the password can join.<br> - Waiting room: A moderator must accept each guest before they can join.<br> - Restricted : Only selected users and groups can access this room." : "Explication des différents concepts qui constituent les options d’accès :\n<br> - Public : Toute personne possédant le lien peut rejoindre la conversation.\n<br> - Interne : Seuls les utilisateurs Nextcloud peuvent rejoindre la conversation.\n<br> - Mot de passe : Seuls les invités possédant le mot de passe peuvent rejoindre la conversation.\n<br> - Salle d’attente : Un modérateur doit accepter chaque invité avant qu’il ne puisse rejoindre la conversation.\n<br> - Restreint : Seuls les utilisateurs et groupes sélectionnés peuvent accéder à cette conversation.",
    ...
    "Require moderator to start room" : "Requiert un modérateur pour démarrer la salle",
    "Listen only option" : "Écoute seule",
    "Skip media check before usage" : "Ignorer le test des périphériques avant utilisation",
    "Clean layout" : "Disposition simple",
